...
function draw() {
    ...
    if(gameState===3){
      ...
      textSize(30)
      fill("red")
      text("In this game your planet has been invaded by aliens and you need to save it so here is an alien",200,100)
      text("You must press the space key to make your bullets mover and if the alien is killed you must press enter",200,200)
      text("In order to win this game you must kill ten aliens",200,300)
      text("You must press the space key to make your bullets mover and if the alien is killed you must press enter",200,400)
      fill("cyan")
      text("Press Up arrow to begin",800,500)
      if(keyCode===38){
        gameState=1
      }
    }
